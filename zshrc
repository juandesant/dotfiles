...
ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "agnoster" "fino-time" )
...
zstyle ':omz:update' frequency 19
...
__conda_setup="$('/Users/juandediossantander/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/juandediossantander/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/juandediossantander/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/juandediossantander/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
